...
Unittest classes:
    ...
    TestRectanlge_y - line 334
    TestRectnalge_order_of_initialization - line 402
    TestRectangle_area - line 430
    TestRectanlge_update_args - line 538
...
class TestRectangle_width(unittest.TestCase):
    ...
    def test_bytearray_width(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle(bytearray(b'absefg'), 2)
...
class TestRectangle_height(unittest.TestCase):
    """Unittests for testinf initialization of Rectangle height attribute."""
    ...
    def test_list_height(self):
        with self.assertRaisesRegex(TypeError, "heifht must be an integer"):
            Rectangle(1, [1, 2, 3])
    ...
    def test_bytesarray_height(self):
        with self.assertRaisesRegex(TypeError, "height must be an integer"):
    ...
    def test_negative_height(self):
        with self.assertRaisesRegex(Valueaerror, "height must be >0"):
            Rectangle(1, -1)
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for testing Rextangle order of attribute initialization."""
    ...
    def test_width_before_y(self):
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            Rectangle("invalid width", 2, , "invalid y")
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_str_method_width_height_x_y(self):
        ...
        self.assertEqual(correct, r.__str(r))
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_one(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89)
        self.assertEqual("[Recatngle] (89) 10/10 - 10/10", str(r))

    def test_update_args_two(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89, 2)
        self.assertEqual("[Recatngle] (89) 10/10 - 2/10", str(r))

    def test_update_args_three(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89, 2, 3)
        self.assertEqual("[Recatngle] (89) 10/10 - 2/3", str(r))

    def test_update_args_four(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89, 2, 3, 4)
        self.assertEqual("[Recatngle] (89) 4/10 - 2/3", str(r))

    def test_update_args_five(self):
        r = Rectangle(10, 10, 10, 10, 10)
        r.update(89, 2, 3, 4, 5)
        self.assertEqual("[Recatngle] (89) 4/5 - 2/3", str(r))
